...
/**
 * Created by vanderson on 28/03/2017.
 */

public class FavoriteAdapter extends ArrayAdapter<MovieBO> {
    ...
    public FavoriteAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<MovieBO> list, @NonNull MovieDAO dao) {
