...
public class PopularAdapter extends ArrayAdapter<MovieBO> {
    ...
    public PopularAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<MovieBO> list, @NonNull MovieDAO dao) {
