...
import br.com.snow.vanderson.snowmovies.adapter.TopAdapter;
 ...
 *
 * Fragment que popula lista
 */

public class TopFragment extends FragmentApp {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.colorTop));
        listViewTop = (ListView) rootView.findViewById(R.id.listViewTop);

        topAdapter = new TopAdapter(getContext(), R.layout.item_movie, listMovie, dao);
    ...
    private void loadMovies(){
        ...
        String url = CreateUrl.getTopRatedMovies(page);
